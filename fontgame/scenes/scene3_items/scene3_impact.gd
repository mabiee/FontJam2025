...
const lines: Array[String] = [
	"Your sketchbook.",
	"It's time for the third guest of the day to arrive."
]
...
func cutscene_1():
	...
	%impact.visible = true
	%impact_AnimationPlayer.play("enter")
	await %impact_AnimationPlayer.animation_finished
	...
	%impact_CollisionShape2D.disabled = false
